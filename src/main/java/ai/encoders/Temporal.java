...
public class Temporal {
	...
	private TimeEncoder.TimeEncoderResult[] time_results;

	/**
	 * A Time object with onlt the decoded time results
	 * @param results
	 */
	public Temporal(TimeEncoder.TimeEncoderResult[] results) {
	...
	public TimeEncoder.TimeEncoderResult[] getTime_results() {
		return time_results;
	}


	public void setTime_results(TimeEncoder.TimeEncoderResult[] time_results) {
